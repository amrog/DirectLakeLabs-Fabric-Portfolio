-- Auto Generated (Do not modify) 2C3F7BAAFE8ECDE893AD4BAEEBB7142B80A37DDF0000FB361FD76F769641A287
create view "dbo_intermediate"."int_account_balances" as -- int_account_balances.sql
...
with gl as (
    select * from "FinanceOps_DW"."dbo_intermediate"."int_gl_transactions"
),
